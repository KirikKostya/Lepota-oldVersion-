              ...
              <div className='PasswordField'>
                <input 
                  ...
                  value={PasswordInputValue}/>
                  {
                    closeFirstEyes
                      ? <svg 
                          onClick={()=>showPassword(TypeForFirstPasswordInput, setTypeForFirstPasswordInput, setCloseFirstEyes)} 
                          width={23} 
                          height={23} 
                          viewBox={'0 0 20 20'} 
                          fill='none'>
              ...
              <div className='PasswordField'>
                <input 
                  ...
                  value={SecondPasswordInputValue}/>
                  {
                    closeSecondEyes
                      ? <svg 
                          onClick={()=>showPassword(TypeForSecondPasswordInput, setTypeForSecondPasswordInput, setCloseSecondEyes)} 
                          width={23} 
                          height={23} 
                          viewBox={'0 0 20 20'} 
                          fill='none'>
